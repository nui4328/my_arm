...
void  arm_mission()  // ยก กางออก
  {
    servo(7, 98 );  //กลาง
    servo(29, 110);delay(200);
    servo(8, 110 ); 
    s8_before_deg = 110;
  }

void  arm_picL( int up_box, int long_box )  // ยก กางออก
  {
    co_xyz( 40, up_box, 15);   // ยกขึ้นตามลำดับกล่อง
    ...
    delay(300);
    co_xyz( long_box, up_box-10, 15);
    delay(300);
    servo(29, 90);delay(200);
    servo(29, 10);delay(100);
    co_xyz( 30, 80, 25);
  }

void  arm_picR( int up_box, int long_box )  // ยก กางออก
  {
    co_xyz( 40, up_box, 15);   // ยกขึ้นตามลำดับกล่อง
